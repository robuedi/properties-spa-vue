<template>
  <q-layout class="bg-grey-2" view="hHh lpR fFf">
    <q-header elevated  height-hint="98">
      <q-toolbar>
        <q-toolbar-title >
          <router-link to="/" class="text-white txt-no-decoration">
            <q-avatar>
        ...
        <div class="GL__toolbar-link q-ml-xs q-gutter-md text-body2 text-weight-bold row items-center no-wrap">
          <q-btn to="/rent"  size="lg" dense flat>
            To Rent
          </q-btn>
          <q-space/>  
          <q-btn to="/buy"  size="lg" dense flat>
            To Buy
          </q-btn>
        </div>
        ...
        <div class="q-pl-sm q-gutter-sm row items-center no-wrap">
          ...
          <q-btn v-if="!auth.isLogged" to="/login"  dense flat>
            Sign In
          </q-btn>
